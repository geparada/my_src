...
for name in $(ls Index13 -d) ; do #Read all directories
	...
	cd $name
	ls -lh Lise_HiSeq1500_1.$name.?_sequence.txt
	...
	~/submit.job -n ${name}.process -s ~/my_src/PhD/Single_Worm/RNASeq-paired-pipe_20worm.sh -q long -m 10000 Lise_HiSeq1500_1.$name.1_sequence.txt Lise_HiSeq1500_1.$name.2_sequence.txt $name 
