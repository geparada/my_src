...
#	print U2_GTAG_5_max_score, U2_GTAG_3_max_score, U2_GCAG_5_max_score, U2_GCAG_3_max_score, U12_GTAG_5_max_score, U12_GTAG_3_max_score, U12_ATAC_5_max_score, U12_ATAC_3_max_score
	...
	for row in reader:
		...
		u2_5 = slices[0].split("-")[0].upper()
		u2_3 = slices[0].split("-")[1].upper()
#		u2_5 = "AGGTAAG"
#		u2_3 = "CTTTTTGG"
	
		u12_5 = slices[1].split("-")[0].upper()
		u12_3 = slices[1].split("-")[1].upper()
		...
		print U2_GTAG_total_score, U12_ATAC_total_score, U12_GTAG_total_score
#		print U2_GTAG_5_score + U2_GTAG_3_score, U2_GTAG_5_max_score + U2_GTAG_3_max_score
