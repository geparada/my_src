...
def main(row_ME, reads_genome, dust, U2_GTAG_5_file, U2_GTAG_3_file, phylop_vertebrates, phylop_primates): #no repbase
	...
	for row in csv.reader(open(row_ME), delimiter = '\t'):
		...
		U2_scores = []
		TOTAL_mean_conservation_vertebrates = []
		...
		for i in micro_exons:
			...
			TOTAL_mean_conservation_primates.append(mean_conservation_primates)
...
if __name__ == '__main__':
	...
	main(sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6], sys.argv[7], sys.argv[8] ) #no repbase
