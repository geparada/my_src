...
def main(ME_final, U2_GTAG_5_file, U2_GTAG_3_file):
	...
	for row in csv.reader(open(ME_final), delimiter = ' '):
		...
		ME_cov_sum = float(ME_cov_sum)
		SJ_cov_sum = float(SJ_cov_sum)

		phi = ME_cov_sum / (ME_cov_sum + SJ_cov_sum)
		log2_ME_cov_sum = np.log2(ME_cov_sum)
		...
		print ME, len_micro_exon_seq_found, ME5_U2_score, ME3_U2_score, phi, ME_cov_sum, log2_ME_cov_sum
