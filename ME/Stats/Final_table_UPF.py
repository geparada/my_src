...
def main(Final_ME_TABLE):
	...
	for row in csv.reader(open(Final_ME_TABLE), delimiter = ' '):
		...
		# 		print len_micro_exon_seq_found, len_micro_exon_seq_found % 3 == 0, HepG2_control_phi, HepG2_UPF_phi, HepG2_UPF_phi/HepG2_control_phi, np.log2(HepG2_UPF_phi/HepG2_control_phi)
		...
		if Hela_control_total>10 and Hela_UPF_total>10:
			...
			if Hela_control_phi!=0 and  Hela_UPF_phi!=0:
				...
				print len_micro_exon_seq_found, len_micro_exon_seq_found % 3 == 0, Hela_control_phi, Hela_UPF_phi, Hela_UPF_phi/Hela_control_phi, np.log2(Hela_UPF_phi/Hela_control_phi)
