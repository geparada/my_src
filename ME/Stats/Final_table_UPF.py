	...
	for row in csv.reader(open(Final_ME_TABLE), delimiter = ' '):
		...
		if HepG2_control_total>10 and HepG2_UPF_total>10:
			...
			if HepG2_control_phi!=0 and  HepG2_UPF_phi!=0:
				...
				print len_micro_exon_seq_found, len_micro_exon_seq_found % 3 == 0, HepG2_ME_control, HepG2_control_total, HepG2_control_phi, HepG2_ME_UPF, HepG2_UPF_total, HepG2_UPF_phi, HepG2_UPF_phi/HepG2_control_phi, np.log2(HepG2_UPF_phi/HepG2_control_phi)
